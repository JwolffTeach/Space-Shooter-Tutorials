...
class Bullet(Sprite):
    ...
    def __init__(self, settings, screen, ship, bulletType=1, direction=0):
        ...
        if(self.bulletType == 1): # Single Bullet
            self.make_single() 
        elif(self.bulletType == 2): # Double Bullet
            self.make_double()
        elif(self.bulletType == 3): # Snake Bullet
            self.make_snake()
